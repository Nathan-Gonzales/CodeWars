/* https://www.codewars.com/kata/52ceafd1f235ce81aa00073a/train/javascript
   ...
   Description: We need a simple function that determines if a plural is needed or not. 
   ...
   plural(0);    // return true
   plural(0.5);   // return true
   plural(1);    // return false
   plural(100); // return true
*/
