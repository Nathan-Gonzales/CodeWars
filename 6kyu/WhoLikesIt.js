/* Link to problem: https://www.codewars.com/kata/5266876b8f4bf2da9b000362/train/javascript
...
function likes(names) {
    switch(names.length){
        ...
        default:
          let leftover = names.length - 2
          return (names[0] + ", " + names[1] + " and " + leftover + " others like this")
    }
}